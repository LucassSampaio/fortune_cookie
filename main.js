// Variáveis
const box_cookie1 = document.querySelector(".box_cookie1")
const box_cookie2 = document.querySelector(".box_cookie2")
const btn_cookie = document.querySelector("#btn_cookie")
const btn_cookie_return = document.querySelector("#btn_cookie_return")
const phraseRandom = document.querySelector("#phraseRandom")
let numberRandom

btn_cookie.addEventListener("click", toggleCard)
btn_cookie_return.addEventListener("click", toggleCard)
box_cookie1.addEventListener("click", showRandomPhrases)

function toggleCard() {
  box_cookie1.classList.toggle("hide")
  box_cookie2.classList.toggle("hide")
}

function getPhrasesByIndex(index) {
...
function showRandomPhrases() {
  numberRandom = Math.round(Math.random() * 60)
  const phrases = getPhrasesByIndex(numberRandom)
  phraseRandom.innerHTML = `${phrases}`
}
